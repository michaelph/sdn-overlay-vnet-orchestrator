...
public class AppUiTopovOverlay extends UiTopoOverlay {
    ...
    private static final String MY_TITLE = "VNetwork Orchestrator";
    private static final String MY_VERSION = "0.1";
    private static final String MY_DEVICE_TITLE = "Virtual Switch";
